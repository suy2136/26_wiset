"""Run the five C-matched ABR allocators with opt-in FP16 safeguards."""
...
EXPERIMENTS = (
    {
        **COMMON, "name": "NBS_C1536_DATA2_SAFE", "method": "nbs",
        "physical_rank": 32,
        "rank_config": "configs/nbs_v19_rank_config.json",
    },
    {
        **COMMON, "name": "UNIFORM_R24_DATA2_SAFE",
        "method": "uniform_lora", "physical_rank": 24,
    },
    {
        **COMMON, "name": "ADALORA_C1536_DATA2_SAFE", "method": "adalora",
        "physical_rank": 32, "allocation_interval": 10,
        "adalora_schedule_epochs": 20,
    },
    {
        **COMMON, "name": "EVA_C1536_DATA2_SAFE", "method": "eva",
    ...
    {
        **COMMON, "name": "SHAPLEY_C1536_DATA2_SAFE", "method": "shapley",
        "physical_rank": 32, "allocation_interval": 10,
...
def main(argv=None):
    args = parse_args(
        argv,
        state_file=(
            RESULTS_ROOT / "abr_c1536_data2_safeguarded_state.json"
        ),
        output_file=(
            RESULTS_ROOT / "abr_c1536_data2_safeguarded_results.csv"
        ),
    )
