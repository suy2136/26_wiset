"""Sequentially train and compact-test ABR NBS experiments C_REPRO-P-Q-R."""
...
def main(argv=None):
    args = parse_args(
        argv,
        state_file=RESULTS_ROOT / "nbs_v19_cpqr_state.json",
        output_file=RESULTS_ROOT / "nbs_v19_cpqr_results.csv",
    )
