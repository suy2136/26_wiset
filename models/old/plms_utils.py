...
from models.old.gpt2 import GPT2TaskHeadModel
from models.old.llama import LlamaTaskHeadModel2
from models.old.mistral import MistralTaskHeadModel
from models.old.opt import OptTaskHeadModel
...
_MODEL_CLASSES = {
    ...
    "llama": ModelClass(**{
        ...
        "model": LlamaTaskHeadModel2,
    }),
    "mistral": ModelClass(**{
        "config": MistralConfig,
        "tokenizer": LlamaTokenizerFast,
        "model": MistralTaskHeadModel,
    }),
    "llava": ModelClass(**{
        "config": LlamaConfig,
        "tokenizer": LlamaTokenizer,
