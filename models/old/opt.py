...
class OptTaskHeadModel(OPTForCausalLM):
    """
    opt with task head for viewport prediction.
    This class is implemented based on OptForCausalLM.
    """
    ...
    def forward(
        ...
        position_ids: Optional[torch.LongTensor] = None,  # note
        ...
        #     input_ids=input_ids,
        #     attention_mask=attention_mask,
        #     position_ids=position_ids,  # note
        #     past_key_values=past_key_values,
        #     inputs_embeds=inputs_embeds,
        #     use_cache=use_cache,
        #     output_attentions=output_attentions,
