...
def main() -> None:
    ...
    display_names = {
        ...
        "nbs_v16": "NBS-NetLLM v16 (budget736, lr2.5e-4, ema0.9)",
        "nbs_v17": "NBS-NetLLM v17 (budget736, lr2e-4, ema0.8)",
        "nbs_v18": "NBS-NetLLM v18 (min2-max32-budget640, seed1)",
        "nbs_v19": "NBS-NetLLM v19 (min2-max32-budget512, seed1)",
        ...
        "nbs_v27": "NBS-NetLLM v27 adaptive (tau0.05, floor128-cap512, seed1)",
        "nbs_v28": "NBS-NetLLM v28 fixed budget512 + active-only shadow",
        "nbs_v29": "NBS-NetLLM v29 (min2-max32-budget192, seed1)",
        "nbs_v19_data2": "NBS-NetLLM v19 data-seed ablation",
        "nbs_budget256_seed1": "NBS-NetLLM v26 (budget256, seed1)",
